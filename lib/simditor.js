...
Clipboard = (function(superClass) {
  ...
  Clipboard.prototype._init = function() {
    ...
    this.editor.body.on('copy', (function(_this) {
      return function(e) {

        /* Explicitly set clipboard data to avoid brining in extra computed styles. */
        var cd, clonedSelection, div, range;
        e.preventDefault();
        range = _this.editor.selection.range();
        if (!(range && !range.collapsed)) {
          return;
        ...
        return cd.setData('text/html', div.innerHTML);
      };
    })(this));
